...
class VectorLogo extends React.Component {
  ...
  render(img) {
    return (
      <svg width={this.props.width} height={this.props.height} key={"logo-" + this.idx} onMouseEnter={this.mouseEnter} onMouseLeave={this.mouseLeave}  key={"logo-" + this.state.idx}>{img}</svg>
      )    
  }
...
class Logo7 extends VectorLogo {
  ...
  render() {
    ...
    for (let i=0; i<20; i++) {
      if (this.state.animate) {
        img.push(<line x1="0" y1={-props.height/2+i*15} x2={props.width} y2={i*15} stroke={props.fill} strokeWidth="4" opacity="1.0">
...
export class LogoFactory extends React.Component {
  ...
  getLogo(idx) {
      switch(idx%8) {
        case 0: return  <Logo0 width={100} height={100} fill="#fff" idx={idx}/>;
        case 1: return  <Logo1 width={100} height={100} fill="#fff" idx={idx}/>;
        case 2: return  <Logo2 width={100} height={100} fill="#fff" idx={idx}/>;
        case 3: return  <Logo3 width={100} height={100} fill="#fff" idx={idx}/>;
        case 4: return  <Logo4 width={100} height={100} fill="#fff" idx={idx}/>;
        case 5: return  <Logo5 width={100} height={100} fill="#fff" idx={idx}/>;
        case 6: return  <Logo6 width={100} height={100} fill="#fff" idx={idx}/>;
        case 7: return  <Logo7 width={100} height={100} fill="#fff" idx={idx}/>;
        default: return <Logo2 width={100} height={100} fill="#fff" idx={idx}/>;
      }
  } 
